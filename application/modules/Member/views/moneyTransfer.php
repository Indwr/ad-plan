  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        ...
        ?></h4>
        <label class="badge badge-info">Minimum Withdrawal: Rs. <?php echo $with_limit;?>/-</label>
	   </div>
          ...
          <div class="card">
            ...
            <label class="badge badge-success">Avaliable Balance: Rs. <?php echo $balance['balance']; ?>/-</label>
               ...
               $withdraw_status = $this->User_model->get_single_record('tbl_admin', array('id' => 1), 'withdraw_status');
                ...
                // $ips = 0;
                //   if($ips == 1){
                   if(date('H:i') >= '11:00' AND date('H:i') <= '13:00' AND date('D') != 'Sun'){
               // if(date('H:i') >= '10:00' AND date('H:i') <= '14:00'){
                      if($withdraw_status['withdraw_status'] == 0){
                        ...
                        echo '<label class="badge badge-danger">Withdrawal Open 11:00AM to 01:00PM (Monday to Saturday)!</label>';
                   }
                 // }else{
