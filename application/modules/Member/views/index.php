...
.sidebar-menu>li:hover>a, .sidebar-menu>li.active>a {
    ...
    border-left-color: #f4a20b !important;
}
.btn-warning {
    color: #fff;
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row main_icon mt-4">

        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon0">
              <div class="media">
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon1">
              <div class="media">
              <div class="media-body text-left">
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon2">
              <div class="media">
              <div class="media-body text-left">
                <h4 class="text-white"><?php if($user_info['paid_status'] > 0){ echo '<span class="">Active</span>  ';}else{ echo '<label class="badge badge-danger">Inactive</label>';}?><?php if($user_info['paid_status'] > 0){ echo'  '. currency_icon.$user_info['package_amount']; }?></h4>
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon3">
              <div class="media">
              <div class="media-body text-left">
                <p><b><font color="#fff">JOINING DATE:</font></b> <font color="#fff"><?php echo $user_info['created_at'];?></font></p>
                <?php if($user_info['paid_status'] > 0){?>
                <p><b><font color="#fff">ACTIVATION DATE:</font></b> <font color="#fff"><?php echo $user_info['topup_date'];?></font></p>
              <?php }?>
              </div>
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon4">
              <div class="media">
              <div class="media-body text-left">
                <?php 
                ...
                ?>
                <p><b><font color="#fff">Total Direct:</font></b> <font color="#fff"><?php echo $totalDirects['directs'];?></font></p>
                <?php if($user_info['paid_status'] > 0){?>
        ...
        <div class="col-12 col-lg-6 col-xl-3 d-none">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon5">
              <div class="media">
              <div class="media-body text-left">
        ...
        <div class="col-12 col-lg-6 col-xl-3 d-none">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon6">
              <div class="media">
              <div class="media-body text-left">
      ...
      <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness new">
            <div class="card-body main_icon7">
              <div class="media">
              <div class="media-body text-left">
                <?php 
                ...
                ?>
                <p><b><font color="#fff">Total E-Pins:</font></b> <font color="#fff"><?php echo $totalEpins['totalEpins'];?></font></p>
                ...
                <!-- <label class="badge badge-danger">Transfer E-Pins: <?php //echo $transferEpins['transferEpins'];?></label> -->
              </b></p>
      ...
      <div class="row main_icon mt-4">
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness total">
            <div class="card-body main_icon8">
              <div class="media">
              <div class="media-body text-left">
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness">
            <div class="card-body main_icon9">
              <div class="media">
              <div class="media-body text-left">
                <h4 class="text-white"><?php 
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card gradient-ohhappiness">
            <div class="card-body main_icon11">
              <div class="media">
              <div class="media-body text-left">
                <h4 class="text-white"><?php 
      ...
      foreach ($incomes as $key => $value) {
        ...
        if($key == 'shopping_wallet'){
          $totalAmount['totalAmount'] = abs($totalAmount['totalAmount']);
        }
          ...
          <div class="card gradient-ohhappiness total">
            <div class="card-body main_icon8">
              ...
              <div class="media-body text-left">
                ...
                $Repurchase = $this->User_model->get_single_record('tbl_repurchase_wallet',array('user_id' => $this->session->userdata['user_id'], 'amount >' => 0), 'ifnull(sum(amount),0) as totalIncome');
                echo currency.number_format($Repurchase['totalIncome'], 2); ?></h4>
                <span class="text-white"><b>Repurchase Income</b></span>
              </div>
	  ...
	  <div class="row main_icon">
	    <div class="col-12 col-lg-6 col-xl-6">
          <div class="card" style="height: 90%;">
		   <div class="card-header">
             ...
             <div class="card-body main_icon12">
       ...
       <div class="card-header">
        ...
        <div class="card-action">
             ...
             <div class="card-body 13">
             <label class="badge badge-success">News:</label>
               ...
               <div class="table-responsive">
                 <table class="table align-items-center table-flush">
                  <thead>
                   ...
                   <?php
                   $tasks = $this->User_model->get_records('tbl_ads', array('status' => 0), '*');
                   foreach ($tasks as $key => $task) {
                      $check = $this->User_model->get_single_record('tbl_ad_watch_history', 'user_id = "'.$this->session->userdata['user_id'].'" AND date(created_at) = date(NOW()) AND ad_id = "'.$task['id'].'"', '*');
                     ?>
                     <tr>
                      <td><?php echo ($key+1) ?></td>
                      <td>Task <?php echo ($key+1); ?></td>
                      <td><?php echo (25/10); ?></td>
                      <td><?php echo ($task['time']) ?> Seconds</td>
                      <td><?php 
                        if(!empty($check)){
                          echo '<label class="badge badge-success">Task Completed</label>';
                        }else{
                          echo '<label class="badge badge-danger">Task Pending</label>';
                        }
                      ?></td>
                      <td>
                        <?php 
                        ...
                        ?>
                        <a href="<?php echo base_url('Member/Management/playTask/'.$task['id']); ?>" class="btn btn-warning" <?php 
                        if(!empty($check)){
                          echo 'style="color: currentColor;
  cursor: not-allowed;
  opacity: 0.5;
                  ...
                  <thead>
                   ...
                   foreach ($singleLeg as $key => $value) {
                     ...
                     <tr>
                      ...
                      <!-- <td><?php// echo (($key != 1) ? '+'.($value['team']) : ($value['team'])); ?></td> -->
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content gradient-scooter border-">
                      ...
                      <div class="modal-body text-white text-center">
                        ...
                        ?><br><br>
                        <h4 class="text-warning text-center"><a class="text-warning" href="#" download>Android App Coming Soon</a></h4>
                      </div>
