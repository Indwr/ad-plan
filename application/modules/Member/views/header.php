...
.card {
  ...
  .card, .gradient-ibiza, .gradient-scooter {
    background: linear-gradient(
45deg
, #08386b, #fba507) !important;
    color: #fff;
}
.btn-primary {
    color: #fff;
    background-color: #fba507 !important;
    border-color: #fba507 !important;
}
.btn-primary:hover {
    color: #fff;
    background-color: #bd7e0b !important;
    border-color: #bd7e0b !important;
}
.main_icon .card-body:after {
...
.main_icon .main_icon0:after {
    content: '\f007';
}
.main_icon .main_icon1:after {
    content: '\f2c2';
}
.main_icon .main_icon2:after {
    content: '\f201';
}
.main_icon .main_icon3:after {
    content: '\f017';
}
.main_icon .main_icon4:after {
    content: '\f0c0';
}
.main_icon .main_icon5:after {
    content: '\f012';
}
.main_icon .main_icon6:after {
    content: '\f084';
}.main_icon .main_icon7:after {
    content: '\f084';
}
.main_icon .main_icon8:after {
    content: '\f156';
}
.main_icon .main_icon9:after {
    content: '\f156';
}
.main_icon .main_icon10:after {
    content: '\f156';
}
.main_icon .main_icon11:after {
    content: '\f156';
}
.main_icon .main_icon12:after {
    content: '\f007';
}
.main_icon .main_icon13:after {
    content: '\f007';
}
 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
       ...
       <i class="fa fa-angle-left pull-right"></i>
        ...
        <ul class="sidebar-submenu">
            <li><a href="<?php echo base_url('Member/Downline/sponserDownline');?>"><i class="fa fa-long-arrow-right"></i> My Team Downline</a></li>
      ...
      <li>
        <a href="javaScript:void();" class="waves-effect">
        <i class="fa fa-user"></i><span>Franchise</span> 
       <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="sidebar-submenu">
            <li><a href="<?php echo base_url('Member/Epin/franchiseList');?>"><i class="fa fa-long-arrow-right"></i> Franchise List</a></li>
        </ul>
      </li>
