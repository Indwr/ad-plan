                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview" style="display: none;">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Jarvis/Management/uploadAds'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Upload Ads</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview" style="display: none;">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Jarvis/Management/uploadAds'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Upload Adverstisement</p>
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Jarvis/Management/uploadAdsHistory'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Adverstisement History</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview" style="display: none;">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Jarvis/Franchise/'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>All Franchise List</p>
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="<?php echo base_url('Jarvis/Franchise/AddFranchise'); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Create New Franchiser</p>
                                        </a>
                                    </li>
