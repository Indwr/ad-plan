          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form method="GET" action="<?php echo base_url('Jarvis/Franchise/index/');?>">
                <div class="row">
                    <div class="col-3">
                      ...
                      $i = ($segament) + 1;
                        foreach ($franchises as $key => $franchise) {
                            ...
                            <tr>
                                ...
                                <td><?php 
                                $pins = $this->Main_model->get_single_record('tbl_epins', array('user_id' => $franchise['user_id'], 'status' => 0), 'count(id) as pins');
                                echo $pins['pins']; ?></td>
                                 <td>
